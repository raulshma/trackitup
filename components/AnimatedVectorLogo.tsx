...
function IsometricBar({ 
  cx, cy, size, animatedHeight, colors 
}: {
  cx: number; cy: number; size: number; animatedHeight: SharedValue<number>; 
...
export function AnimatedVectorLogo({ onAnimationFinish }: AnimatedVectorLogoProps) {
  ...
  useEffect(() => {
    ...
    lineProgress.value = withDelay(1200, withTiming(1, { 
      duration: 1200, 
  ...
  return (
    <View style={styles.container}>
      <Svg viewBox="0 0 800 800" width={200} height={200}>
        ...
        <G>
          <IsometricBar cx={482.5} cy={352} size={size} animatedHeight={h4} colors={Bar4C} />
          <IsometricBar cx={427.5} cy={384} size={size} animatedHeight={h3} colors={Bar3C} />
          <IsometricBar cx={372.5} cy={416} size={size} animatedHeight={h2} colors={Bar2C} />
          <IsometricBar cx={317.5} cy={448} size={size} animatedHeight={h1} colors={Bar1C} />
